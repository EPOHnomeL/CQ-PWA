...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-dvh">
      {/* Header */}
      <header
        className="fixed top-0 left-0 right-0 bg-surface/95 backdrop-blur-md border-b border-white/5 z-40"
        style={{
          height: "var(--app-header-offset)",
          paddingTop: "var(--app-safe-top)",
        }}
      >
        <div className="h-14 max-w-lg mx-auto px-4 flex items-center justify-between">
      ...
      <main
        ...
        style={{
          ...
          paddingBottom: "var(--app-nav-offset)",
        }}
      >
